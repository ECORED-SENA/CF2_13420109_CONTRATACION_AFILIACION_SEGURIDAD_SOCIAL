export default {
        ...
        subMenu: [
          {
            ...
            numero: '1.1',
            titulo:
              'Aplicación del derecho de <i>habeas data</i> en el proceso de contratación y administración documental',
            hash: 't_1_1',
          },
          {
            icono: 'far fa-file-alt',
  ...
  referencias: [
    ...
    {
      referencia:
        'Superintendencia de Industria y Comercio de Colombia. (2022). Argumentos y concepto de aplicación del derecho de <i>habeas data</i>. SIC. ',
